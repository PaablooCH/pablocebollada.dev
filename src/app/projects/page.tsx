    ...
    return (
        <div className="min-h-[calc(100dvh-60px)] px-5 pt-5 sm:px-10">
            ...
            <div className="projects-grid mt-12 pb-12">
                ...
                <ProjectCard title="Megaman" description="2D game developed in C++, with an in-house engine, based on The Goonies (NES) with a Megaman 7 aesthetic." image="/Megaman.png" link="megaman" tags={["C++", "OpenGL", "Tiled"]}></ProjectCard>
            </div>
        </div>
    );
}
