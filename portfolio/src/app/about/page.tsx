        ...
        <div className={`min-h-[calc(100dvh-60px)] px-10 pt-5`}>
            ...
            <div>
                ...
                <div className="flex gap-6 w-full rounded-2xl mt-4 items-start overflow-x-auto snap-x snap-mandatory py-4 px-2">
                    ...
                    <Experience position="Full-Stack Developer" company="Horizons Games" period="March 23-Nov 24" description={["Developed a corporate web application using React and Tailwind.", "Developed a corporate web application using React and Tailwind.", "Implemented features in C++ across different system components.", "Developed rendering features using multiple shaders for diverse rendering purposes."]}></Experience>
                    <Experience position="Full-Stack Developer" company="IThink UPC" period="Feb 22-Feb 23" description={["Performed profiling and debugging using a variety of performance analysis tools.", "Developed responsive web applications using Angular and TypeScript.", "Collaborated closely with the design team to implement UI components.", "Developed backend services using Spring Boot and Java."]}></Experience>
                    <Experience position="Full-Stack Developer (Internship)" company="Telespazio Ibérica" period="Apr 21-Jan 22" description={["Optimized application performance and overall user experience.", "Developed responsive web applications using Angular and TypeScript.", "Developed responsive web applications using Angular and TypeScript."]}></Experience>
                </div>
